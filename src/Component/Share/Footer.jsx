    ...
    <div>
      <footer className="footer p-10 bg-base-200 text-base-content">
        <nav>
          ...
          <p className="text-xl font-bold">Your Journey, Our Responsibility</p>
        </nav>
        <nav>
      ...
      <footer className="footer px-10 py-4  bg-base-200 text-base-content  border-t border-success ">
